 ...
 * @since AM 5.5.0
 */
public class restAuthTreeNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(restAuthTreeNodePlugin.currentVersion, 
				Collections.singletonList(restAuthTreeNode.class));
	}
	...
	public String getPluginVersion() {
		return restAuthTreeNodePlugin.currentVersion;
	}
}
